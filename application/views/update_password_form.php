	...
	<form action="<?php echo $this->config->base_url();?>index.php/user/changepasswordaction/" method="post">
		<table class="table table-bordered table-striped table-hover">
			<tr>
				...
				<td><input type="password" name="password" placeholder="Password" value="<?php echo $result[0]->password;?>"></td>
			</tr>
			<tr>
				<td><?php echo $common_password;?></td>
				<td><input type="password" name="repassword" placeholder="Retype password" value="<?php echo $result[0]->password;?>"></td>
			</tr>
		</table>
